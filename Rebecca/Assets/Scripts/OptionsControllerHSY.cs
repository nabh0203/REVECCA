...
public class OptionsControllerHSY : MonoBehaviour
{
    public Slider bgmSlider;
    public Slider sfxSlider;
    public Slider brightnessSlider;
    public MainSceneHSY mainScene;
    ...
    {
        AudioManagerHSY.Instance.SetBGMVolume(bgmSlider.value);
    }

    public void OnSFXVolumeChange()
    {
        AudioManagerHSY.Instance.SetSFXVolume(sfxSlider.value);
    }
