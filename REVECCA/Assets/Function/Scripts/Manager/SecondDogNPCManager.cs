...
public class SecondDogNPCManager : Interactable
{
    ...
    private void DisplayNextDialogue()
    {
        ...
        else 
        {
            ...
            // 모든 대화가 출력되었다면 대화 종료
            HideDialogue();
            // 특정 대화 인덱스에 따라 DogSound 또는 BarkSound 실행
    ...
    {
        AudioManagerNBH.Audioinstance.PlayOtehrSFX(AudioManagerNBH.OtherSFX.DogSound);
        Debug.Log("대화 종료");
